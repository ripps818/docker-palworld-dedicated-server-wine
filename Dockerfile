...
ENV DEBIAN_FRONTEND=noninteractive \
    ...
    UE4SS_EXPERIMENTAL_URL="https://github.com/Okaetsu/RE-UE4SS/releases/latest" \
    # Webhook-settings
    ...
    WEBHOOK_INFO_DESCRIPTION="This is information from the server" \
    ...
    WEBHOOK_RESTART_DELAYED_DESCRIPTION="The automatic gameserver restart has been triggered, the server will wait 15 minutes before restarting if players are still connected." \
    ...
    WEBHOOK_UPDATE_VALIDATION_DESCRIPTION="Server is being updated and all gameserver files are being validated" \
